...
void CreateAnArray(int iArray[], int *firstElementIndex, int *lastElementIndex)
{
    ...
    // printf("The position should not be Zero i.e 0 - because we cannot add elements before this Position");
    // printf("So enter any number in between the Range- ");
    // printf("We are using a part of Array - out of the given big array");
    scanf("%d", &position);
...
void AddElementAtTheBeginningOfArray(int iArray[], int *lastElementIndex)
{
}
