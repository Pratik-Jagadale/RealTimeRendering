...
float gfTranslate = 0.0f;
bool gbGoPositive = true;
bool gbXTransalate = false;
bool gbYTranslate = false;
bool gbZTranslate = false;
...
void display(void)
{
	...
	if(gbXTransalate == true)
		glTranslatef( gfTranslate, 0.0f, -9.0f); // left to right right to left
	else if(gbYTranslate == true)
		glTranslatef( 0.0f, gfTranslate, -9.0f); // up down
	else if(gbZTranslate == true)
		glTranslatef( 0.0f, -0.0f ,gfTranslate - 6.0f); // front to rear rear to front
	else
		glTranslatef( 0.0f, 0.0f, -6.0f);
	/*
		glTranslatef( 0.0f, 0.0f , -6.0f);
		glTranslatef( 0.0f, 0.0f ,gfXTranslate);
	*/
...
void update(void)
{
	...
	//gfXTranslate = gfXTranslate + 0.002;
	if(gbGoPositive == true )
	{
		if(gfTranslate <= 3.0f)
			gfTranslate = gfTranslate + 0.002f;
		else
			gbGoPositive = false;
	}
	else{
