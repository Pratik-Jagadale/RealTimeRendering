...
float xEyeVector = 0;
float yEyeVector = 0;
float zEyeVector = -8.0f;

float xCenterVector = 0.0f;
float yCenterVector = 0.0f;
float zCenterVector = 0.0f;

float xUpVector = 0.0f;
float yUpVector = 1.0f;
float zUpVector = 0.0f;
...
char title[255] = "Camera Implimentation";
...
{
    /* code */
    sprintf(title, "x = %f , y = %f z = %f", xEyeVector, yEyeVector, zEyeVector);
}
