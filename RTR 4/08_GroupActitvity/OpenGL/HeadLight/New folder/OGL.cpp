...
GLfloat gfLightPositions[] = {0.0f, 2.0f, -6.0f, 1.0f};
GLfloat gfLightSpotLightDirection[] = {0.0f, -1.0f, -2.0f, 1.0};
...
const GLfloat angle1 = 90.0f;
const GLfloat angle2 = 2.0f;
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CHAR:
		...
		case 'w':
		case 'W':
			// if (gfLightPositions[2] >= -15.0f)
			gfLightPositions[2] -= 0.2f;

			break;

		case 'a':
		case 'A':
			if (gfLightPositions[0] >= -4.0f)
				gfLightPositions[0] -= 0.2f;

			break;

		case 's':
		case 'S':
			if (gfLightPositions[2] <= -5.0f)
				gfLightPositions[2] += 0.2f;
		...
		case 'D':
			if (gfLightPositions[0] <= 4.0f)
				gfLightPositions[0] = gfLightPositions[0] + 0.2f;
			break;
		case 'R':
		case 'r':
			gfLightPositions[0] = 0.0f;
			gfLightPositions[2] = -6.0f;
			break;
...
void draw24Sphere(void)
{
	...
	materialDefuse[1] = 0.0f; // g
	materialDefuse[2] = 0.0f; // b
	materialDefuse[3] = 1.0f; // a
	glMaterialfv(GL_FRONT, GL_DIFFUSE, materialDefuse);

	materialSpecular[0] = 1.0;	// r
	materialSpecular[1] = 0.0;	// g
	materialSpecular[2] = 0.0;	// b
	...
	// 2 nd Column
	materialDefuse[0] = 1.0f; // r
	materialDefuse[1] = 0.5f; // g
	materialDefuse[2] = 0.0f; // b
	materialDefuse[3] = 1.0f; // a
	glMaterialfv(GL_FRONT, GL_DIFFUSE, materialDefuse);

	materialSpecular[0] = 1.0;	// r
	materialSpecular[1] = 0.5;	// g
	materialSpecular[2] = 0.0;	// b
	materialSpecular[3] = 1.0f; // a
	glMaterialfv(GL_FRONT, GL_SPECULAR, materialSpecular);
	...
	glPushMatrix();
	// 4 th nd Column
	materialDefuse[0] = 0.0f; // r
	materialDefuse[1] = 1.0f; // g
	materialDefuse[2] = 0.0f; // b
	materialDefuse[3] = 1.0f; // a
	glMaterialfv(GL_FRONT, GL_DIFFUSE, materialDefuse);

	materialSpecular[0] = 0.0;	// r
	materialSpecular[1] = 1.0;	// g
	materialSpecular[2] = 0.0;	// b
	materialSpecular[3] = 1.0f; // a
	glMaterialfv(GL_FRONT, GL_SPECULAR, materialSpecular);
	...
	glPushMatrix();
	// 6 th Column
	materialDefuse[0] = 0.294f; // r
	materialDefuse[1] = 0.0f;	// g
	materialDefuse[2] = 0.509f; // b
	materialDefuse[3] = 1.0f;	// a
	glMaterialfv(GL_FRONT, GL_DIFFUSE, materialDefuse);

	materialSpecular[0] = 0.294; // r
	materialSpecular[1] = 0.0;	 // g
	materialSpecular[2] = 0.509; // b
	materialSpecular[3] = 1.0f;	 // a
	glMaterialfv(GL_FRONT, GL_SPECULAR, materialSpecular);
	...
	glPushMatrix();
	// 7 th Column
	materialDefuse[0] = 0.937f; // r
	materialDefuse[1] = 0.509f; // g
	materialDefuse[2] = 0.937f; // b
	materialDefuse[3] = 1.0f;	// a
	glMaterialfv(GL_FRONT, GL_DIFFUSE, materialDefuse);

	materialSpecular[0] = 0.937; // r
	materialSpecular[1] = 0.509; // g
	materialSpecular[2] = 0.937; // b
	materialSpecular[3] = 1.0f;	 // a
	glMaterialfv(GL_FRONT, GL_SPECULAR, materialSpecular);
