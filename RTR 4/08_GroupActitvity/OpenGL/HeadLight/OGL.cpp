...
GLfloat gfLightAmbiant_zero[] = {1.0f, 1.0f, 1.0f, 1.0f};
GLfloat gfLightDeffuse_zero[] = {1.0f, 1.0f, 1.0f, 0.0f};
GLfloat gflightSpecular_zero[] = {1.0f, 1.0f, 1.0f, 1.0f};
GLfloat gfLightPositions_zero[] = {0.0f, 1.0f, 0.0f, 0.0f};
...
GLfloat gfLightPositions[] = {0.0f, 1.0f, 0.0f, 1.0f};
GLfloat gfLightSpotLightDirection[] = {0.0f, 0.0f, -1.0f, 1.0};
...
int initialize(void)
{
    ...
    // light 0
    /*
    glLightfv(GL_LIGHT0, GL_AMBIENT, gfLightAmbiant_zero);
    glLightfv(GL_LIGHT0, GL_DIFFUSE, gfLightDeffuse_zero);
    glLightfv(GL_LIGHT0, GL_POSITION, gfLightPositions_zero);
