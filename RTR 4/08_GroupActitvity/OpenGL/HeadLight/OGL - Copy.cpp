...
GLfloat gfLightPositions[] = {0.0f, 0.5f, -6.0f, 1.0f};
GLfloat gfLightSpotLightDirection[] = {0.0f, -1.0f, 0.0f};
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CHAR:
        ...
        case 'l':
            ...
            fprintf_s(gpFile, " %f, %f, %f\n", gfLightPositions[0], gfLightPositions[1], gfLightPositions[2]);

            break;

        case 'w':
            gfLightPositions[2] -= 0.1f;
            // fprintf_s(gpFile, " %f, %f, %f\n", gfLightPositions[0], gfLightPositions[1], gfLightPositions[2]);
            break;

        case 'a':
            gfLightPositions[0] -= 0.1f;
            fprintf_s(gpFile, " %f, %f, %f\n", gfLightPositions[0], gfLightPositions[1], gfLightPositions[2]);
            break;
        ...
        case 'd':
            gfLightPositions[0] = gfLightPositions[0] + 0.1f;
            fprintf_s(gpFile, " %f, %f, %f\n", gfLightPositions[0], gfLightPositions[1], gfLightPositions[2]);
            break;
...
void draw24Sphere(void)
{
    ...
    */
    ...
    glMatrixMode(GL_MODELVIEW);
    glLoadIdentity();
    glTranslatef(-3.0f, -1.0f, -7.5f);
    gluSphere(quadric, 0.5f, 30, 30);

    glMatrixMode(GL_MODELVIEW);
    glLoadIdentity();
    glTranslatef(-3.0f, -1.0f, -9.0f);
    gluSphere(quadric, 0.5f, 30, 30);

    glMatrixMode(GL_MODELVIEW);
    glLoadIdentity();
    glTranslatef(-3.0f, -1.0f, -10.5f);
    gluSphere(quadric, 0.5f, 30, 30);
