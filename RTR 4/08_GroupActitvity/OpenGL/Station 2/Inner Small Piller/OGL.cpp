...
void display(void)
{
    ...
    glVertex3f(-15.0f, -4.0f, 2.5f);
    glVertex3f(15.0f, -4.0f, 2.5f);
    setColor(0, 0, 0);
    // setColor(47, 79, 79);
    glVertex3f(15.0f, -4.0f, -12.0f);
    glVertex3f(-15.0f, -4.0f, -12.0f);
    glEnd();
    ...
    {
        glLoadIdentity();
        glTranslatef(-4.5f, -2.6f, -10.5f - k);
