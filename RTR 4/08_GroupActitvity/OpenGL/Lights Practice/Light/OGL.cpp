...
GLfloat gfLightSpotLightDirection[] = {0.0f, 0.0f, -1.0f};
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CHAR:
        ...
        case 'a':
            ...
            gfLightSpotLightDirection[0] -= 0.1f;
            break;
        ...
        case 'd':
            ...
            gfLightPositions[0] = gfLightPositions[0] + 0.1f;
            gfLightSpotLightDirection[1] += 0.1f;
            break;
...
const GLfloat angle1[] = {45.0f};
const GLfloat angle2[] = {35.0f};
...
void display(void)
{
    ...
    // diffuse material
    gfLightDeffuse[0] = 0.75164; // r
    gfLightDeffuse[1] = 0.60648; // g
    gfLightDeffuse[2] = 0.22648; // b
    gfLightDeffuse[3] = 1.0f;    // a
    glMaterialfv(GL_FRONT, GL_DIFFUSE, gfLightDeffuse);
