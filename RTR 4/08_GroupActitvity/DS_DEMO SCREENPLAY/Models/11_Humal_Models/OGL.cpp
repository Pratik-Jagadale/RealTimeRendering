...
int initialize(void)
{
    ...
    // glClearColor(210 / 255, 180 / 255, 140 / 255, 1.0f);
...
void drawRushi(void)
{
    ...
    DrawBox(0.4f, 1.3f, 1.5f, 1.3f, 1.5f);

    // left shoulder
    glPopMatrix();
    glPushMatrix();
    glTranslatef(-0.5f, 1.4f, 0.0f);
    DrawBox(0.4f, 1.1f, 0.6f, 1.2f, 1.5f);
    ...
    DrawBox(1.5f, 1.5f, 1.0f, 1.5f, 1.0f);

    // stomoch
    glPopMatrix();
    glPushMatrix();
    glTranslatef(0.0f, -0.5f, 0.0f);
    DrawBox(0.5f, 1.0f, 1.2f, 1.0f, 1.2f);

    // bottom
    glPopMatrix();
    glPushMatrix();
    glTranslatef(0.0f, -0.8f, 0.0f);
    DrawBox(0.2f, 1.2f, 1.2f, 1.2f, 1.2f);
    ...
    DrawBox(1.5f, 1.5f, 1.0f, 1.5f, 0.9f);
    ...
    DrawBox(1.5f, 1.5f, 1.0f, 1.3f, 0.7f);
    ...
    DrawBox(0.2f, 0.30f, 0.34f, 0.6f, 0.7f);
...
void DrawBox(float height, float topWidth, float bottomWidth, float topDepth, float bottomDepth)
{
    glBegin(GL_QUADS);
    // FRONT FACE
