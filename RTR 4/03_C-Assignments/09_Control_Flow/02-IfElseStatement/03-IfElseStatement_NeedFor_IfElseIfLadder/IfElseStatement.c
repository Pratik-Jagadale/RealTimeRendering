...
int main(void)
{
    ...
    {
        if ((num_PRJ > 0) && (num_PRJ <= 100)) //if - 02
        {
            printf("Num = %d Is Between 0 to 100  !!!!\n\n", num_PRJ);
        }
        else
        {
            if ((num_PRJ > 100) && (num_PRJ <= 200)) //if - 03
            {
                printf("Num = %d Is Between 100 to 200  !!!!\n\n", num_PRJ);
            }
            else
            {
                if ((num_PRJ > 200) && (num_PRJ <= 300)) //if - 04
                {
                    printf("Num = %d Is Between 200 to 300  !!!!\n\n", num_PRJ);
                }
                else
                {
                    if ((num_PRJ > 300) && (num_PRJ <= 400)) //if - 05
                    {
                        printf("Num = %d Is Between 300 to 400  !!!!\n\n", num_PRJ);
                    }
                    else
                    {
                        if ((num_PRJ > 400) && (num_PRJ <= 500)) //if - 06
                        {
