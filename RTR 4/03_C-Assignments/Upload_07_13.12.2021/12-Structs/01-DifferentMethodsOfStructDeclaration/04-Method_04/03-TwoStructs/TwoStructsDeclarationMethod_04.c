...
int main(void)
{
    ...
    struct MyPoint point_PRJ; // declaring a single variable of type 'struct MyPoint' locally

    struct MyPointProperties point_properties; //delcaring a single variable of type 'struct MyPointProperties' locally
