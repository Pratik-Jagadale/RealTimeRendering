...
int main(void)
{
    ...
    // *** Using Array Name as A Array  i.e Value Of xth Element of iArray :
    // iArray[x] And Address of xth Elemet of iArray_PRJ[x] ***
    printf("\n\n");
    printf("Using Array Name as A Array  i.e Value Of xth Element of iArray iArray[x] And Address of xth Element of iArray_PRJ[x]\n\n");
    ...
    // *** Using Pointer as Pointer i.e : Value of xTh Element of iArrau :
    // (ptr_iArray + x) And Address of xTh Element of iArray : (ptr_iArray + x) ***

    printf("\n\n");
    printf("Using Pointer as Pointer i.e : Value of xTh Element of iArray_PRJ :(ptr_iArray + x) And Address of xTh Element of iArray : (ptr_iArray + x) \n\n");

    printf("*(ptr_iArray_PRJ + 0) = %d \t At Address : %p\n", *(ptr_iArray_PRJ + 0), (iArray_PRJ + 0));
    printf("*(ptr_iArray_PRJ + 1) = %d \t At Address : %p\n", *(ptr_iArray_PRJ + 1), (iArray_PRJ + 1));
    printf("*(ptr_iArray_PRJ + 2) = %d \t At Address : %p\n", *(ptr_iArray_PRJ + 2), (iArray_PRJ + 2));
    printf("*(ptr_iArray_PRJ + 3) = %d \t At Address : %p\n", *(ptr_iArray_PRJ + 3), (iArray_PRJ + 3));
    printf("*(ptr_iArray_PRJ + 4) = %d \t At Address : %p\n", *(ptr_iArray_PRJ + 4), (iArray_PRJ + 4));
    printf("*(ptr_iArray_PRJ + 5) = %d \t At Address : %p\n", *(ptr_iArray_PRJ + 5), (iArray_PRJ + 5));
    printf("*(ptr_iArray_PRJ + 6) = %d \t At Address : %p\n", *(ptr_iArray_PRJ + 6), (iArray_PRJ + 6));
    printf("*(ptr_iArray_PRJ + 7) = %d \t At Address : %p\n", *(ptr_iArray_PRJ + 7), (iArray_PRJ + 7));
    printf("*(ptr_iArray_PRJ + 8) = %d \t At Address : %p\n", *(ptr_iArray_PRJ + 8), (iArray_PRJ + 8));
    printf("*(ptr_iArray_PRJ + 9) = %d \t At Address : %p\n", *(ptr_iArray_PRJ + 9), (iArray_PRJ + 9));
