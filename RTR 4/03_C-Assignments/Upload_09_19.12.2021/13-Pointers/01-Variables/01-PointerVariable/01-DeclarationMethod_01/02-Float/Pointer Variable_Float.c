...
int main(void)
{
    ...
    float num_PRJ;
    float *ptr_PRJ = NULL; //Declaration Method 1 :- '*ptr' is a variable of type 'float'
    ...
    printf("value of 'num_PRJ'               =%f\n\n", num_PRJ);
    printf("Addres of 'num_PRJ'              =%p\n\n", &num_PRJ);
    printf("value At Address of 'num_PRJ'    =%f\n\n", *(&num_PRJ));
    ...
    printf("value of 'num_PRJ'                                 =%f\n\n", num_PRJ);
    printf("Addres of 'num_PRJ'                                =%p\n\n", &num_PRJ);
    printf("value At Address of ptr_PRJ i.e. *(&'num_PRJ')     =%f\n\n", *ptr_PRJ);
