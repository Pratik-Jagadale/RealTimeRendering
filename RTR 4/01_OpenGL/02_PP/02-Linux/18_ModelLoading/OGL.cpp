...
GLuint gVao_model;			// Vertex Array Object
GLuint gVbo_model_position; // Vertex Buffer Object
...
int initiallize(void)
{
	...
	// gVao_model and vba related code
...
void uninitiallize(void)
{
	...
	// deletion of gVbo_model_Position
