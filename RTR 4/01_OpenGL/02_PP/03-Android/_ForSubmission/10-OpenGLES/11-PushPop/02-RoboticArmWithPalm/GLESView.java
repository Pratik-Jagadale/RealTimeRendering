...
public class GLESView extends GLSurfaceView implements OnDoubleTapListener, OnGestureListener, GLSurfaceView.Renderer {
    ...
    private void display() {
        ...
        Matrix.rotateM(rotationMatrix, 0, shoulder, 0.0f, 0.0f, 1.0f);
        ...
        GLES32.glBindVertexArray(vao_sphere[0]);
        GLES32.glVertexAttrib3f(MyGLESMacros.PRJ_ATTRIBUTE_COLOR, 0.5f, 0.35f, 0.005f);
        ...
        Matrix.rotateM(rotationMatrix, 0, palm, 0.0f, 0.0f, 1.0f);
        ...
        Matrix.translateM(translationMatrix, 0, 0.4f, 0.0f, 0.0f);

        Matrix.multiplyMM(modelMatrix, 0, modelMatrix, 0, translationMatrix, 0);
        /////////////////////////////////////////////////////////////////////
        // *** PUSH 4 (Palm Mid Point) ***

        Stack.pushMatrix(modelMatrix);

        Matrix.scaleM(scaleMatrix, 0, 1.0f, 0.35f, 1.0f);
