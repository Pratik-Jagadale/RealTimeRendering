...
function display() {
    ...
    var rotationMatrix_Day = mat4.create();
    var rotationMatrix_Year = mat4.create();
    ...
    gl.uniformMatrix4fv(modelMatrixUniform, false, scaleMatrix);
    ...
    viewMatrix = mat4.clone(popMatrix());
    ...
    {
        mat4.rotateY(rotationMatrix_Year, rotationMatrix_Year, year);
        mat4.translate(translationMatrix, translationMatrix, [2.0, 0.0, 0.0]);

        mat4.rotateY(rotationMatrix_Day, rotationMatrix_Day, day);

        mat4.scale(scaleMatrix, scaleMatrix, [0.3, 0.3, 0.3]);

        mat4.multiply(modelMatrix, rotationMatrix_Year, translationMatrix);
        mat4.multiply(modelMatrix, modelMatrix, rotationMatrix_Day);
        ...
        pushMatrix(modelMatrix);
        {
            ...
            gl.uniformMatrix4fv(viewMatrixUniform, false, viewMatrix);
            gl.uniformMatrix4fv(projectionMatrixUniform, false, perspectiveProjectionMatrix);
            gl.uniform3f(colorUniform, 0.0, 1.0, 1.0);
            sphere.draw();
        ...
        // Moon
        rotationMatrix_Year = mat4.create();
        scaleMatrix = mat4.create();
