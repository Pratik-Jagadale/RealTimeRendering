...
function initialize() {
    ...
    gl.bindAttribLocation(shaderProgramObject, webGLMacros.PRJ_ATRIBUTE_POSITION, "a_position");
    ...
    gl.vertexAttribPointer(webGLMacros.PRJ_ATRIBUTE_POSITION, 3, gl.FLOAT, false, 0, 0);
    gl.enableVertexAttribArray(webGLMacros.PRJ_ATRIBUTE_POSITION);
