...
void display(void)
{
	...
	mat4 rotatenMatrix = mat4::identity();
	mat4 modelMatrix = mat4::identity();
	mat4 viewMatrix = mat4::identity();

	translationMatrix = vmath::translate(0.0f, -0.0f, -6.0f); // glTranslatef() is replaced by this line
	rotatenMatrix = vmath::rotate(angleModel, 0.0f, 1.0f, 0.0f);
	modelMatrix = translationMatrix * rotatenMatrix;
