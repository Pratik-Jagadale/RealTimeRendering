...
GLuint gVao_mesh;		   // Vertex Array Object
GLuint gVbo_mesh_position; // Vertex Buffer Object
GLuint gVbo_mesh_normal;
GLuint gVbo_mesh_element;
...
float mesh_vertices[1146];
float mesh_normals[1146];
float mesh_textures[764];
unsigned short mesh_elements[2280];
int gNumVertices;
int gNumElements;
...
int initialize(void)
{
	...
	// LOAD MODEL
	new_mash_data = load_mesh("MonkeyHead.obj");
	...
	// position vbo
	glGenBuffers(1, &gVbo_mesh_position);
	glBindBuffer(GL_ARRAY_BUFFER, gVbo_mesh_position);
	...
	// normal vbo
	glGenBuffers(1, &gVbo_mesh_normal);
	glBindBuffer(GL_ARRAY_BUFFER, gVbo_mesh_normal);
	...
	// element vbo
	glGenBuffers(1, &gVbo_mesh_element);
	glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, gVbo_mesh_element);
...
void uninitialize(void)
{
	...
	/*  */
	// deletion of gVbo_mesh_element
	if (gVbo_mesh_element)
	{
		glDeleteBuffers(1, &gVbo_mesh_element);
		gVbo_mesh_element = 0;
	}

	// deletion of gVbo_mesh_normal
	if (gVbo_mesh_normal)
	{
		glDeleteBuffers(1, &gVbo_mesh_normal);
		gVbo_mesh_normal = 0;
	}

	// deletion of gVbo_mesh_Position
	if (gVbo_mesh_position)
	{
		glDeleteBuffers(1, &gVbo_mesh_position);
		gVbo_mesh_position = 0;
	}

	// deletion of gVao_mesh
	if (gVao_mesh)
	{
