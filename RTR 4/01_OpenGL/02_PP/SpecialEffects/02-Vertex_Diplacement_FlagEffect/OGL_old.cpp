...
float numberOfWaves = ((2 * M_PI) / 0.3f); // k = ( 2PI / lambada) lamvda is distance between two waves
// float numberOfWaves = M_PI / 2;
float velocityOfWave = 10.5f;
float amplitudeOfWave = 0.1f; // height of wave
...
void display(void)
{
	...
	scalenMatrix = vmath::scale(1.0f, 1.0f, 1.0f);
