...
int initialize(void)
{
	...
	glBufferData(GL_ARRAY_BUFFER, new_mash_data->gp_vertex_filter->size * sizeof(float), new_mash_data->gp_vertex_filter->p_arr, GL_STATIC_DRAW);
	...
	glBufferData(GL_ARRAY_BUFFER, new_mash_data->gp_normal_filter->size * sizeof(float), new_mash_data->gp_normal_filter->p_arr, GL_STATIC_DRAW);
