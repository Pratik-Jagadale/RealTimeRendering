...
void display(void)
{
    ...
    glLoadIdentity();
    glTranslatef(-3.0f, 1.5f, -6.0f);

    glRotatef(angleVertical, 1.0f, 0.0f,0.0f);
    ...
    glRotatef(angleHorizontal, 0.0f, 1.0f,0.0f);
    ...
    glRotatef(angleVertical, 0.0f, 0.0f, 1.0f);
...
{
    /* code */
    angleHorizontal = angleHorizontal + 0.9;
    if(angleHorizontal >= 360.0f)
        angleHorizontal = -360.0f;

     angleVertical = angleVertical + 0.9;
    if(angleVertical >= 360.0f)
        angleVertical = -360.0f;
}
