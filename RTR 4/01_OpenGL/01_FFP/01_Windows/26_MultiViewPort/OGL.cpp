...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		...
		{
		case '1':
			glViewport(0, 0, (GLsizei)(iWidthOfscreen / 2), (GLsizei)(iHeightOfScreen / 2));
			break;
		case '2':
			glViewport((iWidthOfscreen / 2), 0, (GLsizei)(iWidthOfscreen / 2), (GLsizei)(iHeightOfScreen / 2));
			break;
		case '3':
			glViewport((iWidthOfscreen / 2), iHeightOfScreen / 2, (GLsizei)(iWidthOfscreen / 2), (GLsizei)(iHeightOfScreen / 2));
			break;
		case '4':
			glViewport(0, iHeightOfScreen / 2, (GLsizei)(iWidthOfscreen / 2), (GLsizei)(iHeightOfScreen / 2));
			break;

		case '5':
			glViewport(0, 0, (GLsizei)(iWidthOfscreen), (GLsizei)(iHeightOfScreen / 2));
			break;
		case '6':
			glViewport(0, iHeightOfScreen / 2, (GLsizei)(iWidthOfscreen), (GLsizei)(iHeightOfScreen / 2));
			break;
		case '7':
			glViewport(0, 0, (GLsizei)(iWidthOfscreen / 2), (GLsizei)(iHeightOfScreen));
			break;
		case '8':
			glViewport(iWidthOfscreen / 2, 0, (GLsizei)(iWidthOfscreen / 2), (GLsizei)(iHeightOfScreen));
			break;
		case '9':
			glViewport(iWidthOfscreen / 4, iHeightOfScreen / 4, (GLsizei)(iWidthOfscreen / 2), (GLsizei)(iHeightOfScreen / 2));
			break;
		default:
