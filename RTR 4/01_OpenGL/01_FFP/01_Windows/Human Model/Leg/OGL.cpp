...
float BodyTransalation[3] = {0.0f, 0.0f, 0.0f};
float BodyRotation[3] = {0.0f, 0.0f, 0.0f};

float RightHandTransaltion[3] = {0.0f, 0.0f, 0.0f};
float LeftHandTransaltion[3] = {0.0f, 0.0f, 0.0f};

float RightLegTransaltion[3] = {0.0f, 0.0f, 0.0f};
float LeftLegTransaltion[3] = {0.0f, 0.0f, 0.0f};

float RightLegTransaltionAngle = PI / 2;
bool RightLegTransaltionFlag = true;
...
void display(void)
{
    ...
    // Trangle *****
    glLoadIdentity();
    glTranslatef(RightLegTransaltion[0] + 1.5f, RightLegTransaltion[1] + 1.2f, -6.0f);

    //  glRotatef(RightLegTransaltionAngle, 0.0f, 1.0f, 0.0f); // Spinning
...
void update(void)
{
    ...
    /*  AnglePyramid = AnglePyramid + 0.05f;
      if (AnglePyramid >= 360.0f)
          AnglePyramid = -360.0f;
  */
    if (RightLegTransaltionAngle < (PI * 2) && RightLegTransaltionFlag == true)
    {
        RightLegTransaltion[0] = cos(RightLegTransaltionAngle);
        RightLegTransaltion[1] = cos(RightLegTransaltionAngle);
        RightLegTransaltionAngle = RightLegTransaltionAngle + 0.0005f;
    }
    else
    {
        RightLegTransaltionFlag = false;
    }

    if (RightLegTransaltionAngle > PI / 4 && RightLegTransaltionFlag == false)
    {
        RightLegTransaltion[0] = cos(RightLegTransaltionAngle);
        RightLegTransaltion[1] = cos(RightLegTransaltionAngle);
        RightLegTransaltionAngle = RightLegTransaltionAngle - 0.0005f;
